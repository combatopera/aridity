...
class TestLoad(TestCase):
    ...
    def test_functionstyle(self):
        ...
        self.assertEqual('sub __main__ function-style-pkg-sub-file\n', self._moduleasmain('others', 'pkg_sub_file'))
        ...
        self.assertEqual('sub pkg.sub.file function-style-pkg-sub-file\n', self._moduleasself('pkg.sub.file', 'functionstyle'))
        ...
        self.assertEqual('sub others function-style-pkg-sub-file\n', self._moduleasself('others', 'pkg_sub_file'))
